...
{
	protected static final native Vector3 wrap(Vector3 v)/*-{
		v.toString = function() {
			return "Vector3("+Math.round(this.x*1000)/1000+","+Math.round(this.y*1000)/1000+","+Math.round(this.z*1000)/1000+")";
		}
		return v;
	}-*/;
	...
	/*-{
		...
		return @net.blimster.gwt.threejs.core.Vector3::wrap(Lnet/blimster/gwt/threejs/core/Vector3;)(new $wnd.THREE.Vector3());
	...
	/*-{
		...
		return @net.blimster.gwt.threejs.core.Vector3::wrap(Lnet/blimster/gwt/threejs/core/Vector3;)(new $wnd.THREE.Vector3(x, y, z));
	...
	public final native void setEulerFromRotationMatrix(final Matrix4 matrix, final String eulerOrder)/*-{
		this.setEulerFromRotationMatrix(matrix, eulerOrder);
	}-*/;
}
